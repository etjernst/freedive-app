...
catalog = [
    ...
    ("sta-co2-vshape", "CO2 table, V-shaped", "STA", "main",
     "co2",
    ...
    ("sta-co2-1breath", "1-breath CO2 ladder", "STA", "main",
     "co2",
    ...
    ("sta-co2-short-intense", "Short & intense CO2", "STA", "main",
     "co2",
    ...
    ("sta-el", "Empty-lung set", "STA", "main, warmup",
     "o2_hypoxia, mental",
    ...
    ("sta-1c-plus", "First-contraction-plus ladder", "STA", "main",
     "co2, mental",
    ...
    ("sta-progressive-fl", "Progressive FL to max", "STA", "main",
     "co2, mental",
